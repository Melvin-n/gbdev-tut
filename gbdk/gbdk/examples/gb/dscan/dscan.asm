...
;dscan.c:121: if(DEVICE_SUPPORTS_COLOR) {
	...
	sub	a, #0x11
	ret	NZ
;C:/Users/melvi/gbdk/gbdk/include/gb/gb.h:1648: shadow_OAM[nb].prop=prop;
	ld	l, c
;	spillPairReg hl
;	spillPairReg hl
	ld	h, #0x00
...
;dscan.c:254: for( n=0; n<40; n++ ) {
	ld	c, #0x00
00107$:
;C:/Users/melvi/gbdk/gbdk/include/gb/gb.h:1602: shadow_OAM[nb].tile=tile;
	ld	l, c
;	spillPairReg hl
;	spillPairReg hl
	ld	h, #0x00
...
;	spillPairReg hl
	...
	inc	hl
	ld	(hl), #0x1e
;C:/Users/melvi/gbdk/gbdk/include/gb/gb.h:1675: OAM_item_t * itm = &shadow_OAM[nb];
	ld	hl, #_shadow_OAM
	add	hl, de
;C:/Users/melvi/gbdk/gbdk/include/gb/gb.h:1676: itm->y=y, itm->x=x;
	xor	a, a
	ld	(hl+), a
	ld	(hl), a
;dscan.c:254: for( n=0; n<40; n++ ) {
...
; ---------------------------------
_main::
;C:/Users/melvi/gbdk/gbdk/include/gb/gb.h:743: __asm__("di");
	di
...
;dscan.c:741: DISPLAY_ON;
	...
	or	a, #0x80
	ldh	(_LCDC_REG + 0), a
;C:/Users/melvi/gbdk/gbdk/include/gb/gb.h:727: __asm__("ei");
	ei
;dscan.c:744: while(1) {
00102$:
